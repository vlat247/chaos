    ...
    <div className="relative w-full max-w-2xl group">
      ...
      <div className="relative">
        <textarea
          ...
          rows={1}
          className="w-full px-6 py-4 pr-14 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white placeholder:text-white/40 text-lg font-sans focus:outline-none focus:ring-2 focus:ring-white/30 transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.1)] resize-none overflow-y-hidden max-h-[150px]"
